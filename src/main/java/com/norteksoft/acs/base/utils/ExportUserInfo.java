...
private static void fillCell(Department dept,List<User> users,HSSFSheet sheet, boolean isBranchAdmin, List<Department> manageDepts){
	String deptName = "";
	...
	for(User user:users){
        ...
        HSSFCell celli12 = rowi.createCell(12);
