...
public class WorkflowEditorAction extends CrudActionSupport<WorkflowDefinition>{
	...
	public String workFlowSaveAs()  throws Exception{
		if (xmlContent != null) {
			//String xmlContentFormat = format(xmlContent);
//			byte[] file=xmlContentFormat.getBytes();//获得文件内容
//			byte[] file=xmlContent.getBytes();//获得文件内容
//			PropUtils.download("myXml.xml", file);
	 ...
	 * @throws IOException 
	 */
//	public static void downloadXML(String fileName,byte[] content) throws IOException{
