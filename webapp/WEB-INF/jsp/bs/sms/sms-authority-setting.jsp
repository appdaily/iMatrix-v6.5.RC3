...
<head>
	...
	function createSmsAuthoritySet(){
		...
		init_colorbox(url,iMatrixMessage["messagePlatform.smsTemplateNew"],600,400,true,refreshListData);
	}
	//回调
	...
	function updateSmsAuthoritySet(){
		...
		if(boxes==null || boxes==""){
			...
			init_colorbox(url,iMatrixMessage["messagePlatform.smsTemplateUpdate"],600,400,true,refreshListData);
		}
	}
	</script>
</head>
