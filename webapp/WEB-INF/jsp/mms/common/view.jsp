	...
	<div class="opt-body">
		<aa:zone name="default_refresh_zone">
			...
			<div id="opt-content">
				...
				<div id="tabs">
					<ul >
						<li><a href="#tabs-1"  onclick="ajaxAnyWhereSubmit('defaultForm1','${mmsCtx}/common/input.htm','button_zone,content_zone',format_Validate);"><s:text name="wf.table.formInformation"/></a></li>
						...
						<aa:zone name="content_zone">
							<form action="" id="default_submit_form" name="default_submit_form" method="post">
								...
								<aa:zone name="history_refresh_zone">
									<view:formView code="${formCode}" entity="${data}" version="${formVersion}" viewable="true"  taskId="${taskId}"></view:formView>
								</aa:zone>
								</form>
									<p><s:text name="common.transact.opinion"></s:text>
									...
									<p><s:text name="common.input.text"></s:text>
									...
									<p><s:text name="common.input.attache"></s:text>
